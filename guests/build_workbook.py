...
gl = wb.active
gl.title = "Guest List"
# The guest list is data, not code: edit guest_list_source.tsv and re-run.
import csv as _csv
with open(OUT.rsplit("/", 1)[0] + "/guest_list_source.tsv") as _f:
    _src = list(_csv.reader(_f, delimiter="\t"))
GL_HEAD = _src[0]
guests = [[r[1], r[2], r[3], r[4], int(r[5]), r[6], r[17]] for r in _src[1:]]
